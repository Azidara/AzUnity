...
//     version 1.3.0
//     from Assets/PlayerController/BasicPlayerInputHandler.inputactions
//
...
public partial class @BasicPlayerInputHandler : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @BasicPlayerInputHandler()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""BasicPlayerInputHandler"",
    ""maps"": [
        {
            ""name"": ""BasicPlayer"",
    ...
    {
        private @BasicPlayerInputHandler m_Wrapper;
        public BasicPlayerActions(@BasicPlayerInputHandler wrapper) { m_Wrapper = wrapper; }
